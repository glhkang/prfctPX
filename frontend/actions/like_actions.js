...
export const createLike = (userId, photoId) => (dispatch) => {
  return LikeAPIUtils.createLike(userId, photoId).then((createLike) => {
    dispatch(receiveLike(createLike));
  });
};

export const deleteLike = (likeId) => (dispatch) => {
  return LikeAPIUtils.deleteLike(likeId).then(() =>
