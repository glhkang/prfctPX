        ...
        <div className="splash-2">
          ...
          <div className="splash-2-body">
            <div className="splash-2-col">
              <img src={window.growIcon} className="splash-2-icon" />
            ...
            <div className="splash-2-col">
              <img src={window.buildIcon} className="splash-2-icon" />
              <h3>Build your career</h3>
              <p>
                Present yourself as a professional. Get hired by displaying your
                services, create a Directory listing, showcase the workshops
                you're holding, and create Galleries to highlight your work.
              </p>
            </div>
            <div className="splash-2-col">
              <img src={window.performIcon} className="splash-2-icon" />
        ...
        <div className="bottom-splash">
          ...
          <div className="bottom-splash-body">
            <span>
              ...
              of like-minded creators to be inspired by incredible photos daily,
              and get rewarded for your talents.
            </span>
          </div>
          ...
          <div className="footer-links">
            <ul>
              <li className="footer-link">
                <a href="https://bit.ly/glorias-linkedin" target="_blank">
                  LinkedIn
                </a>
              </li>
              <li className="footer-link">
                <a href="https://bit.ly/glorias-github" target="_blank">
                  GitHub
                </a>
              </li>
              <li className="footer-link">
                <a href="http://bit.ly/glorias-angellist" target="_blank">
                  AngelList
                </a>
              </li>
              <li className="footer-link">
                <a href="https://bit.ly/glorias-portfolio" target="_blank">
                  Gloria Kang
                </a>
              </li>
            </ul>
